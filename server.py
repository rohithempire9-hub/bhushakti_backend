...
app=FastAPI(title='BHUSAKTHI Early Warning & Response API',version='4.2.0')
...
@app.get('/health')
def health():return {'status':'ok','version':'4.2.0','weather':'Open-Meteo','database':'mongodb' if db is not None else 'memory','demo_mode':db is None}
